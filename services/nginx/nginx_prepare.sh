...
COUNTRY="GR"                # 2 letter country-code
STATE="Athens"            # state or province name
LOCALITY="Athens"        # Locality Name (e.g. city)
ORGNAME="Fogus Innovations & Services P.C." # Organization Name (eg, company)
ORGUNIT="Innovation"                  # Organizational Unit Name (eg. section)
COMMONNAME="$CAPIF_HOSTNAME"
EMAIL="charismiadis@fogus.gr"    # certificate's email address
